...
def trova_calciatori_comuni_arg_it(elenco):
    # Inizializziamo due set per tenere traccia dei calciatori dell'Argentina e dell'Italia
    ...
    for giocatore in elenco:
        ...
        # Controlliamo se il calciatore ha giocato per l'Argentina o per l'Italia (ITA) e se il nome non è vuoto
        if nome_calciatore and nazionalita:
...
if calciatori_comuni:
    for calciatore in calciatori_comuni:
        print("I calciatori che hanno giocato sia per l'Argentina che per l'Italia sono:", calciatore)
else:
    print("Nessun calciatore ha giocato sia per l'Argentina che per l'Italia.")
